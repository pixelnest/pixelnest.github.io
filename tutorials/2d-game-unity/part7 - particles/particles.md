...
**Tip:** if you have transparency issue, make sure transparent pixels are black ones with 0 alpha.

Assign the sprite as the particle: drag'n'drop the texture to the _Particle System_ in the hierarchy or the editor.
