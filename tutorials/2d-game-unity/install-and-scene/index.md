...
Let's start Unity. First thing you will, after a short splashscreen, is the project manager dialog.
...
Sprites are the images of your game. In a 2D project, sprites are textures that can be used in the 2D tools.
